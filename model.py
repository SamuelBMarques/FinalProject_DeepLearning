...
# import
from nn_fromscratch import SWDataset
...
def main():
    ...
    # Model
    model = AdvancedCNN1D(in_channels=8, sampling_points=SAMPLING_POINTS, num_classes=3).to(device)
